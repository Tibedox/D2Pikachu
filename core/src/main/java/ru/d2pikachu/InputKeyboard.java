...
public class InputKeyboard {
    ...
    public InputKeyboard(BitmapFont font, float scrWidth, float scrHeight, int enterTextLength){
        ...
        keyboardWidth = scrWidth/21f*20; // ширина клавиатуры
        keyboardHeight = scrHeight/5f*3; // высота клавиатуры
        x = (scrWidth- keyboardWidth)/2;   // x клавиатуры
        y = keyboardHeight +scrHeight/30f; // y клавиатуры
        keyWidth = keyboardWidth /13; // ширина каждой клавиши
        keyHeight = keyboardHeight /5; // высота каждой клавиши
        padding = 0; // отступы между кнопками
        createKBD();
    }
